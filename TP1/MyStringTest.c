...
{
  char buffer1[]= "ABCDEF--abcdef";
  char * result1= MyString_memcpy_ascend (buffer1 + 8, buffer1, 6);
  assert (result1 == buffer1 + 8);
  assert (memcmp (buffer1, "ABCDEF--ABCDEF", 14) == 0);

  char buffer2[]= "GHIJKL--ghijkl";
  char * result2= MyString_memcpy_ascend (buffer2 + 6, buffer2, 8);
  assert (result2 == buffer2 + 6);
  assert (memcmp (buffer2, "GHIJKLGHIJKLGH", 14) == 0);
                 
  char buffer3[]= "MNOPQR--mnopqr";
  char * result3= MyString_memcpy_ascend (buffer3, buffer3 + 6, 8);
  assert (result3 == buffer3);
  assert (memcmp (buffer3, "--mnopqrmnopqr", 14) == 0);
}
*/
...
{
  char buffer1[]= "ABCDEF--abcdef";
  char * result1= MyString_memcpy_descend (buffer1 + 8, buffer1, 6);
  assert (result1 == buffer1 + 8);
  assert (memcmp (buffer1, "ABCDEF--ABCDEF", 14) == 0);

  char buffer2[]= "GHIJKL--ghijkl";
  char * result2= MyString_memcpy_descend (buffer2 + 6, buffer2, 8);
  assert (result2 == buffer2 + 6);
  assert (memcmp (buffer2, "GHIJKLGHIJKL--", 14) == 0);
                 
  char buffer3[]= "MNOPQR--mnopqr";
  char * result3= MyString_memcpy_descend (buffer3, buffer3 + 6, 8);
  assert (result3 == buffer3);
  assert (memcmp (buffer3, "qrmnopqrmnopqr", 14) == 0);
}
*/
...
{
  char buffer1[]= "ABCDEF--abcdef";
  char * result1= MyString_memmove (buffer1 + 8, buffer1, 6);
  assert (result1 == buffer1 + 8);
  assert (memcmp (buffer1, "ABCDEF--ABCDEF", 14) == 0);

  char buffer2[]= "GHIJKL--ghijkl";
  char * result2= MyString_memmove (buffer2 + 6, buffer2, 8);
  assert (result2 == buffer2 + 6);
  assert (memcmp (buffer2, "GHIJKLGHIJKL--", 14) == 0);
 
  char buffer3[]= "MNOPQR--mnopqr";
  char * result3= MyString_memmove (buffer3, buffer3 + 6, 8);
  assert (result3 == buffer3);
  assert (memcmp (buffer3, "--mnopqrmnopqr", 14) == 0);
...
{
  unsigned char block[]= { 0xDE, 0xAD, 0xBE, 0xEF };
  assert (MyString_memchr (block, 0xFF, 4) == NULL);
  unsigned char * found= MyString_memchr (block, 0xBE, 4);
  assert (found != NULL && * found == 0xBE && found - block == 2);
}
*/
...
MyStringTest_memset (void)
{
  ...
  unsigned char expected[]= { 0xBA, 0xBA, 0xBA };
  void * result= MyString_memset (bytes, 0xBA, 3);
  assert (result == bytes);
  assert (memcmp (bytes, expected, 3) == 0);
}
*/
